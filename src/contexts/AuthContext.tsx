 ...
 * e Funções estamos armazenando no contexto. 
 * Em nosso projeto será a Interface AuthContextProps.
 */
...
export function AuthProvider({ children }: AuthProviderProps) {
   ...
   * definindo todas as suas propriedades com os valores padrões. 
   ...
   * que foram implementadas dentro da lógica do componente e 
	 * mantidas no contexto.
   */
